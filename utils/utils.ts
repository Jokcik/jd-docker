...
export class Utils {
  ...
  public getArg(key: string, defaultValue: any) {
    return this.args[key] || defaultValue;
  }

  public parallel(count: number, func: (start: number, end: number, part: number) => Promise<any>, threads: number = 20) {
